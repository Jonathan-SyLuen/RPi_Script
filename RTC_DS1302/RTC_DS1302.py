...
# Write seconds data.
      self.WriteByte(operator.mod(Second, 10) | operator.floordiv(Second, 10) * 16)
# Write minute data.
      self.WriteByte(operator.mod(Minute, 10) | operator.floordiv(Minute, 10) * 16)
# Write hour data.
      self.WriteByte(operator.mod(Hour, 10) | operator.floordiv(Hour, 10) * 16)
# Write day data.
      self.WriteByte(operator.mod(Day, 10) | operator.floordiv(Day, 10) * 16)
# Write month data.
      self.WriteByte(operator.mod(Month, 10) | operator.floordiv(Month, 10) * 16)
# Write day of week data.
      self.WriteByte(operator.mod(DayOfWeek, 10) | operator.floordiv(DayOfWeek, 10) * 16)
# Write year of week data.
      self.WriteByte(operator.mod(Year, 10) | operator.floordiv(Year, 10) * 16)
# Make sure write protect is turned off.
      self.WriteByte(int("00000000", 2))
# Make sure trickle charge mode is turned off.
      self.WriteByte(int("00000000", 2))
